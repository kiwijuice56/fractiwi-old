// Sourced from https://github.com/marmitoTH/godot-psx-shaders
shader_type spatial; 
render_mode skip_vertex_transform, cull_disabled, diffuse_lambert_wrap, specular_phong;
...
uniform float cull_distance = 20;
